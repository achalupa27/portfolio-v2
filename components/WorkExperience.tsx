...
function Experience({ experiences }: Props) {
    return (
        <div className='h-screen flex relative overflow-hodden flex-col text-left md:flex-row max-w-full px-10 justify-evenly mx-auto items-center'>
            ...
            <div className='w-full flex mt-12 overflow-x-scroll snap-x snap-mandatory scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#0084ff]/80 items-center justify-center'>
