...
const WebsiteCard = ({ project }: Props) => {
  return (
    <div className="flex items-center justify-center p-12 py-20 md:p-44">
      <div className="mt-12 flex h-[420px] w-[300px] cursor-pointer flex-col items-center justify-center rounded-3xl border border-blue-400 shadow-xl transition duration-500 hover:shadow-gray-900/20 dark:rounded-none dark:border-amber-600 dark:bg-gray-900 dark:hover:bg-[#111827] dark:hover:shadow-amber-700/20 sm:mt-0 sm:w-[420px] md:w-[700px] xl:h-[550px] xl:w-[1000px]">
