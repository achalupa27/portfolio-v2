    ...
    return (
        <>
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1.5 }} className='h-screen flex relative flex-col text-center max-w-[2000px] xl:px-10 min-h-screen justify-center mx-auto items-center'>
                <h3 className='absolute top-24 uppercase tracking-[20px] text-teal-500 dark:text-amber-600 font-light text-2xl'>Skills</h3>
                <h4 className='absolute top-36 uppercase tracking-[3px] dark:text-amber-600/50 text-teal-500/60 text-xs md:text-sm'>
                    <span className='text-teal-500 dark:text-amber-600 animate-bounce'>Hover</span> for proficiency. <span className='text-teal-500 dark:text-amber-600'>Click</span> for use cases.
                </h4>
                <h4 className='my-4 uppercase tracking-[3px] text-teal-500 dark:text-amber-600 text-xs md:text-sm'>Advanced</h4>
                ...
                <h4 className='my-4 uppercase tracking-[3px] text-teal-500 dark:text-amber-600 text-xs md:text-sm'>Intermediate</h4>
                ...
                <h4 className='my-4 uppercase tracking-[3px] text-teal-500 dark:text-amber-600 text-xs md:text-sm'>Novice</h4>
